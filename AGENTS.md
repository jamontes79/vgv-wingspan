...
Wingspan is a collection of AI-assisted engineering tools — skills, agents, and hooks — released as a Codex plugin.
...
Codex and Codex-compatible packages.
...
Wingspan uses Codex hooks to automate behavior at tool-call boundaries. Hooks are defined in `hooks/hooks.json`.
